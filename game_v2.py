'''
Сгенерируем документацию для нашей функции. Для этого в теле функции прописываем тройные кавычки (символ docstring),
и, если у вас установлено расширение Python Docstring Generator, шаблон документации будет создан автоматически. 
...
def random_predict(number:int=1) -> int:
    ...
    return(count) # Возвращаем количество попыток угадывания рандомного числа
...
def score_game(random_predict) -> int:
    """За какое количество попыток в среднем из 1000 подходов, функция угадывает наш алгоритм
